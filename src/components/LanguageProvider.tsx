...
const translations = {
  pt: {
    ...
    "experience.aapvr.desc1.1": "Análise de Dados Comerciais: Desenvolvimento de um sistema automatizado para extração, tratamento e carregamento de dados, otimizando a gestão de vendas, inadimplência, retenção, ouvidoria e call center com Excel e Power BI.",
    "experience.aapvr.desc1.2": "Gestão de KPIs: Criação de dashboards para monitoramento de desempenho, vendas, retenção, inadimplência e conversão de leads.",
    "experience.aapvr.desc1.3": "Controle de Pagamentos de Comissões: Gerenciamento do fluxo de pagamentos e cálculos de comissões das equipes de vendas, inadimplência e retenção.",
    "experience.aapvr.desc1.4": "Tráfego Pago: Análise e otimização de campanhas no Facebook Ads e Google Ads para maximizar investimentos e segmentação de públicos.",
    "experience.aapvr.desc1.5": "Campanhas Comerciais: Planejamento e execução de campanhas para promoção de produtos e serviços.",
    "experience.aapvr.desc1.6": "Gestão de Convênios: Gestão administrativa de convênios, com foco em controle de vigência, documentação e integração com sistemas internos.",
    "experience.aapvr.desc1.7": "Suporte à Gerente Comercial: Apoio direto à gestão, assumindo responsabilidades durante períodos de ausência.",
    "experience.aapvr.desc1.8": "Conferência de Documentação: Verificação e validação da documentação para inclusão de novos clientes e atualização de cadastros.",
    "experience.aapvr.desc1.9": "Controle de Materiais de Estoque: Acompanhamento e gerenciamento de materiais para operações comerciais, garantindo reposição eficiente.",
    "experience.aapvr.desc1.10": "Suporte ao Time Comercial: Fornecimento de insights estratégicos para captação, retenção e recuperação de clientes.",
  ...
  en: {
    ...
    "experience.aapvr.desc1.1": "Commercial Data Analysis: Developed an automated system for data extraction, processing, and loading, optimizing the management of sales, delinquency, retention, customer service, and call center using Excel and Power BI.",
    "experience.aapvr.desc1.2": "KPI Management: Built dashboards to monitor performance, sales, retention, delinquency, and lead conversion.",
    "experience.aapvr.desc1.3": "Commission Payment Control: Managed payment flows and calculated commissions for sales, retention, and collection teams.",
    "experience.aapvr.desc1.4": "Paid Traffic: Analyzed and optimized Facebook Ads and Google Ads campaigns to maximize ROI and audience segmentation.",
    "experience.aapvr.desc1.5": "Commercial Campaigns: Planned and executed campaigns to promote products and services.",
    "experience.aapvr.desc1.6": "Agreement Management: Handled administrative control of agreements, focusing on deadlines, documentation, and system integration.",
    "experience.aapvr.desc1.7": "Support to Commercial Manager: Provided direct support to management, taking over strategic responsibilities during absences.",
    "experience.aapvr.desc1.8": "Documentation Review: Verified and validated documentation for onboarding new clients and updating records.",
    "experience.aapvr.desc1.9": "Inventory Control: Managed and tracked materials for commercial operations, ensuring efficient restocking.",
    "experience.aapvr.desc1.10": "Commercial Team Support: Delivered strategic insights to drive customer acquisition, retention, and recovery.",
