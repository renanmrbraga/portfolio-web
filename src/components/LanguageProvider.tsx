...
const translations = {
  pt: {
    ...
    "skills.section.analysis": "Análise e Modelagem de Dados",
    "skills.list.analysis": "Python (Pandas, NumPy, Scikit-learn, XGBoost), clusterização (K-Means, Silhouette), modelos supervisionados, pré-processamento, tuning, validação cruzada e métricas (AUC, F1, RMSE)",
    "skills.section.viz": "Visualização e BI",
    "skills.list.viz": "Excel Avançado, Power BI (DAX), Streamlit, ECharts, Plotly, Matplotlib, Seaborn",
    "skills.section.eng": "Engenharia e Integração de Dados",
    "skills.list.eng": "SQL (joins, CTEs), ETL, APIs, scraping, pipelines, PostgreSQL, MongoDB, Pinecone",
    "skills.section.dev": "Arquitetura de Sistemas e Deploy",
    "skills.list.dev": "Git, Docker, documentação, FastAPI, LLMs, RAG",
  ...
  en: {
    ...
    "skills.section.analysis": "Data Analysis and Modeling",
    "skills.list.analysis": "Python (Pandas, NumPy, Scikit-learn, XGBoost), clustering (K-Means, Silhouette), supervised models, preprocessing, tuning, cross-validation and metrics (AUC, F1, RMSE)",
    "skills.section.viz": "Data Visualization and BI",
    "skills.list.viz": "Advanced Excel, Power BI (DAX), Streamlit, ECharts, Plotly, Matplotlib, Seaborn",
    "skills.section.eng": "Data Engineering and Integration",
    "skills.list.eng": "SQL (joins, CTEs), ETL, APIs, scraping, pipelines, PostgreSQL, MongoDB, Pinecone",
    "skills.section.dev": "System Architecture and Deployment",
    "skills.list.dev": "Git, Docker, documentation, FastAPI, LLMs, RAG",
    // Project pages common
