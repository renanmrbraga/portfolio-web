...
const ProjectsGrid = () => {
  ...
  const projects: Project[] = [
    ...
    {
      id: "personal-analyst",
      title: "Personal Analyst",
      description: t("projects.PersonalAnalystGrid.desc"),
      tags: ["Python", "FastAPI", "LangChain", "Groq", "PostgresSQL", "Vector DB", "Docker"],
      demoUrl: "https://chatbot-llm-theta.vercel.app/",
      githubUrl: "https://github.com/renanmrbraga/personal-analyst",
      detailsPath: "/projects/personal-analyst",
    },
    {
      id: "football-science",
